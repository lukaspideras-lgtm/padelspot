...
interface CourtChipsProps {
  selectedCourtId: string | null;
  onSelect: (courtId: string) => void;
}

export function CourtChips({ selectedCourtId, onSelect }: CourtChipsProps) {
      ...
      {COURTS.map((court) => {
        ...
        return (
          <Pressable
            ...
            <Text style={[styles.chipText, { color: theme.text }]}>{court.name}</Text>
          </Pressable>
        );
      })}
    </View>
